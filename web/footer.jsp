        ...
        <div class="row">
            ...
            <div class="col l4 offset-l2 s12">
                ...
                <ul>
                    ...
                    <li><a class="grey-text text-lighten-3" href="loginEnregistrement.jsp">Enregistrement</a></li>
                    <li><a class="grey-text text-lighten-3" href="loginUtilisateur.jsp">Utilisateurs</a></li>
                </ul>
            </div>
        </div>
    </div>
