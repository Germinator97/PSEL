<%-- 
    Document   : loginProfesseur
    Created on : 26 mai 2018, 13:31:57
    Author     : germinator
--%>
...
<html>
    ...
    <body style="background-image: url('Images/inp-hb sud 07.jpg')">
        ...
        <form class="login-block" onsubmit="return validate();" method="post" id="connexion" name="connexion" action="loginProfesseur">
            <h1>Login</h1>
