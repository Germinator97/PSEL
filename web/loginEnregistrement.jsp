...
<html>
    ...
    <body style="background-image: url('Images/inp-hb sud 07.jpg')">
        ...
        <form class="login-block" onsubmit="return validate();" method="post" id="connexion" name="connexion" action="loginEnregistrement">
            <h1>Login</h1>
            ...
            <%
                ...
                if (request.getAttribute("id")!= null) {
                    ...
                    if (id != 0) {
                        ...
                        response.sendRedirect("loginEnregistrement.jsp");
                    }
                }
